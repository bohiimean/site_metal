...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.catalog.context_processors.footer_nav',
                'apps.leads.context_processors.captcha',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='metal'),
        'USER': config('DB_USER', default='metal'),
        'PASSWORD': config('DB_PASSWORD', default='metal'),
